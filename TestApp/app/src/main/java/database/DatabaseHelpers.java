...
public class DatabaseHelpers extends SQLiteOpenHelper {
    ...
    public static String DELETE_FOLDER_PATH= Environment.getExternalStorageDirectory() + "/NIKSHAY";
    private static String DB_NAME = AppConstant.DATABASE;
    private static String DB_NAME1 = Environment.getExternalStorageDirectory() + "/NIKSHAY/database/" + DB_NAME;//"
    ...
    private boolean checkDataBase1() {
        ...
        try {
            ...
            if (file.exists() && !file.isDirectory()) {
                ...
                File dbfile = new File(Environment.getExternalStorageDirectory() + "/NIKSHAY/database");
                dbfile.mkdirs();
